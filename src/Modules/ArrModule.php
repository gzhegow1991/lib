...
if (! defined('_ARR_WALK_MODE_DEPTH_FIRST')) define('_ARR_WALK_MODE_DEPTH_FIRST', 1 << 0);
if (! defined('_ARR_WALK_MODE_BREADTH_FIRST')) define('_ARR_WALK_MODE_BREADTH_FIRST', 1 << 1);
if (! defined('_ARR_WALK_SORT_SELF_FIRST')) define('_ARR_WALK_SORT_SELF_FIRST', 1 << 2);
if (! defined('_ARR_WALK_SORT_PARENT_FIRST')) define('_ARR_WALK_SORT_PARENT_FIRST', 1 << 3);
if (! defined('_ARR_WALK_SORT_CHILD_FIRST')) define('_ARR_WALK_SORT_CHILD_FIRST', 1 << 4);
...
if (! defined('_ARR_WALK_WITH_EMPTY_ARRAYS')) define('_ARR_WALK_WITH_EMPTY_ARRAYS', 1 << 7);
if (! defined('_ARR_WALK_WITHOUT_EMPTY_ARRAYS')) define('_ARR_WALK_WITHOUT_EMPTY_ARRAYS', 1 << 8);
if (! defined('_ARR_WALK_WITH_PARENTS')) define('_ARR_WALK_WITH_PARENTS', 1 << 9);
if (! defined('_ARR_WALK_WITHOUT_PARENTS')) define('_ARR_WALK_WITHOUT_PARENTS', 1 << 10);
