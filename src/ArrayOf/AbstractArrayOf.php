...
abstract class AbstractArrayOf implements \ArrayAccess, \Countable, \Serializable, \IteratorAggregate
{
    ...
    )
    {
        ...
        if (! isset($mapKeyTypes[ $_keyType ])) {
            $debugKeyType = Lib::debug_value($_keyType);
        ...
        if (! isset($mapTypes[ $_type ])) {
            $debugKeyType = Lib::debug_value($_type);
    ...
    public function offsetGet($offset)
    {
        if (! $this->offsetExists($offset)) {
            $debugOffset = Lib::debug_value($offset);
    ...
    public function offsetSet($offset, $value)
    {
        if ($this->options[ 'isKeyType' ]) {
            if (! (true
                ...
                $debugOffset = $debugOffset ?? Lib::debug_value($offset);
        ...
        if ($this->options[ 'isOfType' ]) {
            if (! (true
                ...
                $debugValue = $debugValue ?? Lib::debug_value($value);
