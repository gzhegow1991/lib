...
if (! defined('_NUM_ROUND_ROUNDING_AWAY_FROM_ZERO')) define('_NUM_ROUND_ROUNDING_AWAY_FROM_ZERO', 1 << 0);
if (! defined('_NUM_ROUND_ROUNDING_TOWARD_ZERO')) define('_NUM_ROUND_ROUNDING_TOWARD_ZERO', 1 << 1);
if (! defined('_NUM_ROUND_ROUNDING_TO_POSITIVE_INF')) define('_NUM_ROUND_ROUNDING_TO_POSITIVE_INF', 1 << 2);
if (! defined('_NUM_ROUND_ROUNDING_TO_NEGATIVE_INF')) define('_NUM_ROUND_ROUNDING_TO_NEGATIVE_INF', 1 << 3);
if (! defined('_NUM_ROUND_ROUNDING_EVEN')) define('_NUM_ROUND_ROUNDING_EVEN', 1 << 4);
if (! defined('_NUM_ROUND_ROUNDING_ODD')) define('_NUM_ROUND_ROUNDING_ODD', 1 << 5);
