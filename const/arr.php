...
if (! defined('_ARR_WALK_WITHOUT_LEAVES')) define('_ARR_WALK_WITHOUT_LEAVES', 1 << 5);
if (! defined('_ARR_WALK_WITH_LEAVES')) define('_ARR_WALK_WITH_LEAVES', 1 << 6);

if (! defined('_ARR_WALK_WITHOUT_EMPTY_ARRAYS')) define('_ARR_WALK_WITHOUT_EMPTY_ARRAYS', 1 << 7);
if (! defined('_ARR_WALK_WITH_EMPTY_ARRAYS')) define('_ARR_WALK_WITH_EMPTY_ARRAYS', 1 << 8);

if (! defined('_ARR_WALK_WITHOUT_PARENTS')) define('_ARR_WALK_WITHOUT_PARENTS', 1 << 9);
if (! defined('_ARR_WALK_WITH_PARENTS')) define('_ARR_WALK_WITH_PARENTS', 1 << 10);

if (! defined('_ARR_WALK_WITHOUT_LISTS')) define('_ARR_WALK_WITHOUT_LISTS', 1 << 11);
if (! defined('_ARR_WALK_WITH_LISTS')) define('_ARR_WALK_WITH_LISTS', 1 << 12);

if (! defined('_ARR_WALK_WITHOUT_DICTS')) define('_ARR_WALK_WITHOUT_DICTS', 1 << 13);
if (! defined('_ARR_WALK_WITH_DICTS')) define('_ARR_WALK_WITH_DICTS', 1 << 14);
