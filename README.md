# LibБиблиотека вспомогательных функций для использования в проектах и остальных пакетах## Установить в проект```composer require gzhegow/lib```## Запустить тесты```php test.php```## Примеры и тесты
